...
```{r}
signifikante_reihen_global_mvm <- which(globalpeak.value.rnase.mvm > 1.3 * globalpeak.value.ctrl.mvm)

#print(signifikante_reihen_global_mvm)
length(signifikante_reihen_global_mvm)
...
```{r}
signifikante_reihen_global_zt <- which(globalpeak.value.rnase.zt > 1.3 * globalpeak.value.ctrl.zt)

#print(signifikante_reihen_global_zt)
length(signifikante_reihen_global_zt)
```
...
```{r}
signifikante_reihen_global_mms <- which(globalpeak.value.rnase.mms > 1.3 * globalpeak.value.ctrl.mms)

#print(signifikante_reihen_global_mms)
length(signifikante_reihen_global_mms)
```
...
Option 1: selbst festgelegter threshould 
```{r}
signifikante_reihen_local_mvm <- which(localpeaks.sumvalues.rnase.mvm > 1.5* localpeaks.sumvalues.ctrl.mvm)

#print(signifikante_reihen_local_mvm)
length(signifikante_reihen_local_mvm)
...
```{r}
signifikante_reihen_local_zt <- which(localpeaks.sumvalues.rnase.zt > 1.5* localpeaks.sumvalues.ctrl.zt)

#print(signifikante_reihen_local_zt)
length(signifikante_reihen_local_zt)
...
```{r}
signifikante_reihen_local_mms <- which(localpeaks.sumvalues.rnase.mms> 1.5* localpeaks.sumvalues.ctrl.mms)

#print(signifikante_reihen_local_mms)
length(signifikante_reihen_local_mms)
