...
```{r}
#=81  #Number of protein you want to see
#x <- c(1:25)
...
for (z in 1:3){
  ...
  if(z == 3){
    colour <- c("lightsteelblue4", "darkseagreen3","paleturquoise3", "seashell2" )
  }else{colour <- c("lightsteelblue4", "darkseagreen3", "lightsteelblue2", "paleturquoise3", "seashell2" )}
