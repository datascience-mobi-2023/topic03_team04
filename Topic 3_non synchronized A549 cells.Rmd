...
MS.Table.ctrl.naremoved = MS.Table.naremoved[,1:75]
MS.Table.rnase.naremoved = MS.Table.naremoved[,76:150]
...
ctrl.clean <- MS.Table.ctrl.naremoved[-non.reproducible,]
rnase.clean <- MS.Table.rnase.naremoved[-non.reproducible,]
```
...
```{r}
sd.rnase = apply(rnase.clean, 1, sd)
...
```{r}
ctrl.zt.reduced <- (ctrl.rep1.zt.scaled + ctrl.rep2.zt.scaled + ctrl.rep3.zt.scaled)/3

rnase.zt.reduced <- (rnase.rep1.zt.scaled + rnase.rep2.zt.scaled + rnase.rep3.zt.scaled)/3
```
