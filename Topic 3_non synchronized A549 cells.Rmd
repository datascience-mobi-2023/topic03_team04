...
```{r}
n=81  #Number of protein you want to see
x <- c(1:25)
...
for (z in 1:3){
  ...
  if(z == 3){
    colour <- c("darkseagreen3", "lightsteelblue4","cadetblue3", "seashell2" )
  }else{colour <- c("darkseagreen3", "cadetblue3", "lightblue3", "paleturquoise3", "seashell2" )}
