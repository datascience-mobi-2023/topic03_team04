...
```{r}
ctrl.rep1z <- ctrl.rep1.naremoved 
ctrl.rep2z <- ctrl.rep2.naremoved 
ctrl.rep3z <- ctrl.rep3.naremoved 
ctrl.repz <- cbind(ctrl.rep1z,ctrl.rep2z,ctrl.rep3z)

rnase.rep1z <- rnase.rep1.naremoved
rnase.rep2z <- rnase.rep2.naremoved 
rnase.rep3z <- rnase.rep3.naremoved 
...
rnase.with.proteinnumbers <- cbind(Nr, rnase.rep.zt.scaled[x, 1:25], Nr, rnase.rep.zt.scaled[x, 26:50], Nr, rnase.rep.zt.scaled[x, 51:75])
View(rnase.with.proteinnumbers)
...
r1c.zt <- ctrl.regithp1.zt.scaled
