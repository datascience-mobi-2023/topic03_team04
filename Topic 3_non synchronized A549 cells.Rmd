...
```{r}
rdeep <- read.csv('archive/Data for comparison/RBP2GO_Human_database_RBPs.csv', header=TRUE, row.names=1, sep = ";")
View(rdeep)
```

Here we convert a table, containing non-RNA dependent proteins to a usefull format.

```{r}
text <- "archive/Data for comparison/Table_HS_Non_RBP.txt"
csv <- "archive/Data for comparison/Table_HS_Non_RBP.csv"
...
Here we identify those proteins that are neither in the Rdeep-data base, nor the table. 
