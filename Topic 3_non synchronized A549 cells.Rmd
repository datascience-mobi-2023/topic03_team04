...
```{r}
signifikante_reihen_mvm <- which(localpeaks.sumvalues.rnase.mvm > 1.5* localpeaks.sumvalues.ctrl.mvm)

#print(signifikante_reihen_mvm)
length(signifikante_reihen_mvm)
...
```{r}
signifikante_reihen_zt <- which(localpeaks.sumvalues.rnase.zt > 1.5* localpeaks.sumvalues.ctrl.zt)

#print(signifikante_reihen_zt)
length(signifikante_reihen_zt)
...
```{r}
signifikante_reihen_mms <- which(localpeaks.sumvalues.rnase.mms> 1.5* localpeaks.sumvalues.ctrl.mms)

#print(signifikante_reihen_mms)
length(signifikante_reihen_mms)
