...
peaks <- apply(rnase3_scaled, 1,
               function(x) {
                 ...
                 peak_indices[peak_sd > 1] #wenn standardabweichung kleiner als 1 wird Wert nicht als Maximum angesehen
                    #hiermit werden auch werte die größer als 20 sind ausgegeben könnte die neighbor variente ersetzen
...
boundary <- apply(rnase3_scaled, 1, function(x){which( x[1] > 9 | x[ncol(rnase3_peaks)] > 9)
